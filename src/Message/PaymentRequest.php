...
{
    public $liveEndpoint = 'https://api.alogateway.com/api/v2/prv/';
    public $liveEndpoint2 = 'https://bill.alogateway.com/order/external/main.action';
    ...
    public function sendData($data)
    {
        ...
        if ($this->getHttpMethod() == 'GET') {
            ...
            $httpRequest = $this->httpClient->createRequest(
                $this->getHttpMethod(),
                $this->getEndpoint().$this->getalogatewayWallet()."/bills/".$this->getComment(),
                array(
                    'Accept' => 'application/json'
                ),
        ...
        try {
            ...
            $httpRequest->setAuth($this->getalogatewayApiId(), $this->getalogatewayApiPass());
